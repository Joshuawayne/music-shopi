    ...
    <table class="table table-hover shadow">
      ...
      <tbody class="bg-white cart-items">
        ...
        <tr class="cart">
          ...
          <td class="text-right align-middle price">{{ $product['item']['price'] }} KES</td>
          ...
          <td class="text-right align-middle full-price">{{ $product['price'] }} KES</td>
        </tr>
        @endforeach
        <tr class="table-primary" id="last-row">
          ...
          <td class="text-right" id="total">{{ $totalPrice }} KES</td>
        </tr>
      </tbody>
    </table>
